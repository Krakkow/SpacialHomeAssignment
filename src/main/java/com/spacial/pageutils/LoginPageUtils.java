...
public class LoginPageUtils {
    ...
    public boolean isErrorMessageDisplayed() {
        return driverUtils.isVisible(LoginPage.LOGIN_ERROR_MESSAGE);
    }

    public String getErrorMessageText() {
        return driverUtils.getTextFromElement(LoginPage.LOGIN_ERROR_MESSAGE);
    }

    public boolean isOnLoginPage() {
        return !driverUtils.findElements(LoginPage.LOGIN_BUTTON).isEmpty();
    }
}
